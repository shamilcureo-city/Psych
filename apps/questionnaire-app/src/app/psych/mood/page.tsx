        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8 space-y-3">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50">
              ...
              <p className="text-sm text-muted-foreground max-w-xs mx-auto">
                No mood entries yet. Log how you&apos;re feeling above to start seeing patterns over time.
                Even a quick daily check-in can reveal powerful insights.
              </p>
            </div>
          )}
        </CardContent>
